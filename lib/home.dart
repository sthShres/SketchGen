...
class _HomeState extends State<Home> {
  ...
  void fetchResponse(var base64Image) async{
    ...
    var url = Uri.parse("http://192.168.2.15:5000/predict");
  ...
  Widget build(BuildContext context) {
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.fromRGBO(35, 40, 138, 1.0),
                  Color.fromRGBO(64, 188, 255, 1.0),
                  Color.fromRGBO(255, 68, 68, 1.0)
                ],
              ),
            ),
          ),
          Center(
            child: Column(
              ...
              children: [
                ...
                child: Container(width: 256, height: 256, decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20),
                ),
                  boxShadow: [
                    BoxShadow(
    ...
    painter: MyCustomPainter(points: points),),),
                ...
                child: Container(child: Center(child: Container(height: 256, width: 256, child: imageOutput)),),
                )
              ],
